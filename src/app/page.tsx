					...
					<div className="flex flex-col sm:flex-row items-center justify-between">
						<div className="flex items-center space-x-6 mb-4 sm:mb-0">
							...
							<div className="text-left">
								<h1 className="text-3xl md:text-4xl font-bold text-amber-100 mb-1 tracking-tight">AG Branch</h1>
								<h2 className="text-xl md:text-2xl text-amber-200 font-semibold">Information Portal</h2>
							</div>
						</div>
						<div className="text-center sm:text-right">
							<p className="text-lg md:text-3xl text-amber-100/90 max-w-xl leading-relaxed font-bold">यत्र गुप्तं तत्र रक्षितम्।</p>
							<p className="text-lg md:text-2xl text-amber-100/90 max-w-xl leading-relaxed font-bold">
								"That which is kept guarded, is truly protected."
							</p>
							<p className="text-sm md:text-lg text-amber-200/80 max-w-xl leading-relaxed font-medium">~नीतिशास्त्र</p>
