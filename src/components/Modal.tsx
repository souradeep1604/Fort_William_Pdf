	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			<div className="relative w-full h-full max-w-full max-h-full bg-white shadow-2xl">
				...
				<div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-r from-amber-900 via-emerald-800 to-amber-900 px-8 py-6 flex items-center justify-between shadow-lg">
					<h2 className="text-2xl font-bold text-amber-100 truncate">{title || "Document Viewer"}</h2>
					<div className="flex items-center space-x-3">
						...
						<button
							onClick={onClose}
							className="p-3 bg-red-600 hover:bg-red-700 rounded-lg transition-colors duration-200 group"
					...
					{hasError ? (
						<div className="w-full h-full flex items-center justify-center bg-gray-50">
							<div className="text-center p-8">
								...
								<button onClick={openInNewTab} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
									Open in New Tab
								</button>
							</div>
						</div>
